...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "FEISHU_APP_ALERT_ENABLED": {
        "title": "Feishu Proactive Alerts",
        "description": "Enable proactive Feishu app-bot push for stock alert monitoring.",
        "category": "notification",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "FEISHU_APP_RECEIVE_ID_TYPE": {
        ...
        "description": "Receiver identifier type for proactive Feishu app alerts: chat_id, open_id, or user_id.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "FEISHU_APP_RECEIVE_IDS": {
        "title": "Feishu Receive IDs",
        "description": "Comma-separated receiver IDs used by proactive Feishu app alerts when a rule does not override targets.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
